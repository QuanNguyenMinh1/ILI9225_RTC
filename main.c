...
/* USER CODE BEGIN 0 */
DateTime_t datetime;
Button_Typdef buttonmode;
Button_Typdef buttonup;
Button_Typdef buttondown;
typedef enum
{
	BINHTHUONG = 0,
	CHINHPHUT = 1,
...
//////////////////////////////////////////////////////////////CHƯƠNG TRÌNH XỬ LÍ PHỤC VỤ NGẮT//////////////////////////////////////////////////////////////
void btn_pressing_callback()
{ if (button_x->GPIO_PIN = GPIO_PIN_0)
	switch (mode)
	{
  ...
  ///////////////BUTTON_DOWN////////////
	if (button_x->GPIO_PIN = GPIO_PIN_2)
		{
	  btn_adjust(down);
		}
}
